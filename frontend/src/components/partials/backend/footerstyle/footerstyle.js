                    ...
                    <Container fluid>
                        <Row className="footer-standard">
                            <Col lg="7">
                                ...
                                <div className="widget text-left">			
                                    <div className="textwidget">
                                        <p><small>© 2022 MidStream. All Rights Reserved. All videos and shows on this platform are trademarks of, and all related images and content are the property of web developers. Duplication and copy of this is strictly prohibited. All rights reserved.</small></p>
                                    </div>
                                </div>                        
                            </Col>
                            ...
                            <Col lg="3" md="6" className="mt-4 mt-lg-0">
                                <div className="widget text-left">
                                    <div className="textwidget">
                                        <h6 className="footer-link-title">MidStream App</h6>
